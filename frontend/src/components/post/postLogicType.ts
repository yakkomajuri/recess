...
export interface postLogicType extends Logic {
    actionCreators: {
        ...
        loadPostSuccess: (post: Post | null, payload?: any) => ({
        ...
        loadPostFailure: (error: string, errorObject?: any) => ({
        ...
        loadCommentsSuccess: (comments: PostComment[] | null, payload?: any) => ({
        ...
        loadCommentsFailure: (error: string, errorObject?: any) => ({
    ...
    actions: {
        ...
        loadComments: () => void;
        loadCommentsSuccess: (comments: PostComment[] | null, payload?: any) => void;
    ...
    asyncActions: {
        ...
        loadCommentsSuccess: (comments: PostComment[] | null, payload?: any) => Promise<any>;
