// Generated by kea-typegen on Thu, 14 Mar 2024 20:36:22 GMT. DO NOT EDIT THIS FILE MANUALLY.
...
export interface userLogicType extends Logic {
    actionCreators: {
        ...
        verifyEmail: () => {
            type: 'verify email (src.userLogic)'
            payload: {
                value: true
            }
        }
    ...
    actionKeys: {
        ...
        'verify email (src.userLogic)': 'verifyEmail'
    ...
    actionTypes: {
        ...
        verifyEmail: 'verify email (src.userLogic)'
